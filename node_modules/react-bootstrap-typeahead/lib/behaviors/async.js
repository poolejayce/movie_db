...
function useAsync(props) {
  var allowNew = props.allowNew,
      ...
      otherProps = (0, _objectWithoutPropertiesLoose2["default"])(props, ["allowNew", "delay", "emptyLabel", "isLoading", "minLength", "onInputChange", "onSearch", "options", "promptText", "searchText", "useCache"]);
...
function withAsync(Component) {
  ...
  AsyncTypeahead.displayName = "withAsync(" + (0, _utils.getDisplayName)(Component) + ")"; // $FlowFixMe
